...
def MPSSEMod(*args):
  return _pylibmpsse.MPSSEMod(*args)
MPSSEMod = _pylibmpsse.MPSSEMod
...
def OpenMod(*args):
  return _pylibmpsse.OpenMod(*args)
OpenMod = _pylibmpsse.OpenMod
...
def FastReadx(*args):
  return _pylibmpsse.FastReadx(*args)
FastReadx = _pylibmpsse.FastReadx

def FastReady(*args):
  return _pylibmpsse.FastReady(*args)
FastReady = _pylibmpsse.FastReady

def ReadMod(*args):
  return _pylibmpsse.ReadMod(*args)
ReadMod = _pylibmpsse.ReadMod

def InternalReadMod(*args):
  return _pylibmpsse.InternalReadMod(*args)
InternalReadMod = _pylibmpsse.InternalReadMod
